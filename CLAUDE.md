...
Keyboard shortcuts: **Space** = play/stop, **Esc** = stop + rewind, **Home** = rewind to 0, **L** = toggle loop, **Cmd/Ctrl-Z** = undo, **Cmd/Ctrl-Shift-Z** / **Cmd/Ctrl-Y** = redo. Shortcuts bail when an editable element (INPUT, TEXTAREA, contenteditable) is focused.
