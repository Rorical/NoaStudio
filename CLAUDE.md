...
Keyboard shortcuts: **Space** = play/stop, **Cmd/Ctrl-Z** = undo, **Cmd/Ctrl-Shift-Z** / **Cmd/Ctrl-Y** = redo. Shortcuts bail when an editable element (INPUT, TEXTAREA, contenteditable) is focused.
