...
Keyboard shortcuts: **Space** = play/stop, **Esc** = stop + rewind, **Home** = rewind to 0, **L** = toggle loop, **M** / **S** = toggle mute/solo on the selected track, **Delete** / **Backspace** = delete the selected clip, **Cmd/Ctrl-D** = duplicate the selected clip, **Cmd/Ctrl-Z** = undo, **Cmd/Ctrl-Shift-Z** / **Cmd/Ctrl-Y** = redo. Click a track header in the Playlist to select it. **Alt-click** a clip to duplicate it in place. Shortcuts bail when an editable element (INPUT, TEXTAREA, contenteditable) is focused.
