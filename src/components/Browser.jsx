...
export default function Browser({ files, plugins, onDragPlugin }) {
        ...
        {tab === 'files' ? (
          ...
          <div className="plugin-list">
            <div className="plugin-section">
              ...
              {generators.map((p) => (
                <div key={p.name} className="plugin-card gen" draggable onDragStart={(e) => onDragStart(e, p)}>
                  <div className="plugin-thumb"><Icon name="synth" size={18} /></div>
            ...
            <div className="plugin-section">
              ...
              {effects.map((p) => (
                <div key={p.name} className="plugin-card fx" draggable onDragStart={(e) => onDragStart(e, p)}>
                  <div className="plugin-thumb fx"><Icon name="tune" size={18} /></div>
                  <div className="plugin-meta">
                    <div className="plugin-name">{p.name}</div>
                    <div className="plugin-tag">{p.tag}</div>
                  </div>
