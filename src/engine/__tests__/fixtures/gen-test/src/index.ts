// AssemblyScript constant generator. Emits paramBuf[0] on every output sample.
// Used by PluginChain tests to verify slot-ordered signal flow.
...
export function noa_state_size(): u32 { return 0; }
export function noa_get_state(outPtr: u32): u32 { return 0; }
export function noa_set_state(inPtr: u32, nBytes: u32): u32 { return 1; }
